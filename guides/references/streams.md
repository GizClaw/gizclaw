...
- Go Server、JavaScript 与 Flutter 的每个原生 DataChannel message 最多承载 1400 bytes；C API v2 最多承载 4 KiB。接收端均按连续 byte stream 重组 HTTP 或 RPC/Event frame。
...
| C API v2 default | 256 KiB | 64 KiB | 4 KiB |
