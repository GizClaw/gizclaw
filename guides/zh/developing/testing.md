...
optional final-speed retention evidence，以及 mandatory bounded-cleanup evidence。Extended
artifact version 12 另外记录 load driver 的 effective `GOGC`；100/500-session 入口显式保留
`GOGC=100`。同目录的
