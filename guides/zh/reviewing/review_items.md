...
| `pkgs/genx/**` | [GenX 总览](/zh/developing/genx/overview) 及对应 Generators、Transformers、Segmentors、Profilers、Labelers 或 Match 页面 | Stream/EOS、interface、Mux、provider adapter 与公共 pipeline 边界 |
