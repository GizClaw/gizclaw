...
This specification applies to `sdk/js`, shared JavaScript packages, generated OpenAPI clients, and Node or Playwright test harnesses.
...
- Browser, Node and test runtime have different support for global, storage, crypto, URL, stream and timer. The target runtime must be specified before use.
...
- Use unit tests for parsers, transformations, SDK helpers, and error handling; use integration tests for cross-package or real browser behavior.
