...
output chunk with the tunnel correlation context and safely resolved Workspace
and stream identifiers. When the connection-scoped output consumer ends, it
