...
Stores the request/response type, client, server interface and route contract generated by Admin HTTP OpenAPI. It describes the management protocol and does not own RuntimeProfile, AI, Peer, or other resource implementations.
