...
type ClientRpcMethodsListRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ClientRpcMethodsListRequest) Reset() {
	*x = ClientRpcMethodsListRequest{}
	mi := &file_payload_system_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ClientRpcMethodsListRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClientRpcMethodsListRequest) ProtoMessage() {}

func (x *ClientRpcMethodsListRequest) ProtoReflect() protoreflect.Message {
	mi := &file_payload_system_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClientRpcMethodsListRequest.ProtoReflect.Descriptor instead.
func (*ClientRpcMethodsListRequest) Descriptor() ([]byte, []int) {
...
func (x *ClientRpcMethodsListResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_payload_system_proto_rawDesc = "" +
	...
	"\f_duration_ms\"\x1f\n" +
	"\x1dClientDeviceSoundPlayResponse\"Z\n" +
...
var file_payload_system_proto_goTypes = []any{
	...
	(*ClientDeviceSoundPlayRequest)(nil),     // 6: gizclaw.rpc.v1.ClientDeviceSoundPlayRequest
	(*ClientDeviceSoundPlayResponse)(nil),    // 7: gizclaw.rpc.v1.ClientDeviceSoundPlayResponse
	(*ClientDeviceFactoryResetRequest)(nil),  // 8: gizclaw.rpc.v1.ClientDeviceFactoryResetRequest
	(*ClientDeviceFactoryResetResponse)(nil), // 9: gizclaw.rpc.v1.ClientDeviceFactoryResetResponse
