// Package rpcapi provides primitives to interact with the peer RPC API.

// Code generated by tools/gzc-rpcapi-gen. DO NOT EDIT.
package rpcapi
...
// ASTTranslateWorkspaceParametersAgentType defines model for ASTTranslateWorkspaceParametersAgentType.
...
// ChatRoomWorkspaceParametersAgentType defines model for ChatRoomWorkspaceParametersAgentType.
...
// DashScopeTenantModelProviderDataApiMode defines model for DashScopeTenantModelProviderDataApiMode.
...
// DoubaoRealtimeAudioFormatType defines model for DoubaoRealtimeAudioFormatType.
...
// DoubaoRealtimeDialogExtraVolcWebsearchType defines model for DoubaoRealtimeDialogExtraVolcWebsearchType.
...
// DoubaoRealtimeFunctionToolType defines model for DoubaoRealtimeFunctionToolType.
...
// DoubaoRealtimeWorkspaceParametersAgentType defines model for DoubaoRealtimeWorkspaceParametersAgentType.
...
// FlowcraftConversationParametersAgentInitiativePolicy defines model for FlowcraftConversationParametersAgentInitiativePolicy.
...
// FlowcraftConversationParametersInitiative defines model for FlowcraftConversationParametersInitiative.
...
// FlowcraftWorkspaceParametersAgentType defines model for FlowcraftWorkspaceParametersAgentType.
...
// ModelKind defines model for ModelKind.
...
// ModelProviderKind defines model for ModelProviderKind.
...
// PeerRunHistoryEntryType defines model for PeerRunHistoryEntryType.
...
// PeerRunHistoryListRequestOrder defines model for PeerRunHistoryListRequestOrder.
...
// VoiceProviderKind defines model for VoiceProviderKind.
...
// VoiceSource defines model for VoiceSource.
...
// VolcTenantModelProviderDataApiMode defines model for VolcTenantModelProviderDataApiMode.
...
// WorkspaceHistoryListRequestOrder defines model for WorkspaceHistoryListRequestOrder.
...
type DoubaoRealtimeASRContext struct {
	...
	Hotwords []DoubaoRealtimeASRHotword `json:"hotwords"`
}
...
type DoubaoRealtimeASRExtra struct {
	...
	EndSmoothWindowMs *int64 `json:"end_smooth_window_ms,omitempty"`
...
type DoubaoRealtimeAudioOutput struct {
	Format DoubaoRealtimeAudioFormat `json:"format"`
	Loudness *int64 `json:"loudness,omitempty"`
...
type DoubaoRealtimeDialogExtra struct {
	...
	VolcWebsearchResultCount *int64 `json:"volc_websearch_result_count,omitempty"`
...
type DoubaoRealtimeJSONSchema struct {
	...
	AnyOf []DoubaoRealtimeJSONSchema `json:"any_of"`
	Description *string `json:"description,omitempty"`
	...
	Properties map[string]DoubaoRealtimeJSONSchema `json:"properties"`
...
type DoubaoRealtimeTTSExtra struct {
	...
	Tts20Model *string `json:"tts_2_0_model,omitempty"`
}
...
type DoubaoRealtimeWorkflowSpec struct {
	...
	Tools []DoubaoRealtimeFunctionTool `json:"tools"`
}
...
type GameRulesetDriveSpec struct {
	...
	ActionRewards map[string]GameRewardSpec `json:"action_rewards"`
	DefaultReward *GameRewardSpec `json:"default_reward,omitempty"`
	GameRewards map[string]GameRewardSpec `json:"game_rewards"`
...
// ModelProviderData defines model for ModelProviderData.
...
type PeerStatus struct {
	...
	GnssAccuracyM *float64 `json:"gnss_accuracy_m,omitempty"`
	GnssAltitudeM *float64 `json:"gnss_altitude_m,omitempty"`
...
// VoiceProviderData defines model for VoiceProviderData.
...
// WorkspaceParameters defines model for WorkspaceParameters.
