...
func createWorkflow(ctx context.Context, c *gizcli.Client, doc apitypes.Workflow) (apitypes.Workflow, error) {
	...
	resp, err := api.CreateWorkflowWithResponse(ctx, adminhttp.WorkflowUpsert{Id: doc.Id, Spec: doc.Spec})
	if err != nil {
		return apitypes.Workflow{}, err
	}
	if resp.JSON200 != nil {
...
func putWorkflow(ctx context.Context, c *gizcli.Client, name string, doc apitypes.Workflow) (apitypes.Workflow, error) {
	...
	resp, err := api.PutWorkflowWithResponse(ctx, name, adminhttp.WorkflowUpsert{Id: doc.Id, Spec: doc.Spec})
	if err != nil {
		return apitypes.Workflow{}, err
	}
	if resp.JSON200 != nil {
