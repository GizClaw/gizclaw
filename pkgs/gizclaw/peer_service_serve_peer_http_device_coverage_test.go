...
var deviceExtensionRoutes = []struct{ method, path, body string }{
	...
	{http.MethodGet, "/gizclaw/v1/friends/invite-token", ""},
	{http.MethodPost, "/gizclaw/v1/friends/invite-token", ""},
	{http.MethodDelete, "/gizclaw/v1/friends/invite-token", ""},
	{http.MethodGet, "/gizclaw/v1/friends", ""},
	{http.MethodPost, "/gizclaw/v1/friends", `{"invite_token":"x"}`},
	{http.MethodGet, "/gizclaw/v1/friends/x", ""},
	{http.MethodDelete, "/gizclaw/v1/friends/x", ""},
	{http.MethodGet, "/gizclaw/v1/friend-groups", ""},
	{http.MethodPost, "/gizclaw/v1/friend-groups", `{"name":"x"}`},
	{http.MethodPost, "/gizclaw/v1/friend-groups/@join", `{"invite_token":"x","name":"x"}`},
	{http.MethodGet, "/gizclaw/v1/friend-groups/x", ""},
	{http.MethodPut, "/gizclaw/v1/friend-groups/x", `{"display_name":"X"}`},
	{http.MethodDelete, "/gizclaw/v1/friend-groups/x", ""},
	{http.MethodGet, "/gizclaw/v1/friend-groups/x/invite-token", ""},
	{http.MethodPost, "/gizclaw/v1/friend-groups/x/invite-token", ""},
	{http.MethodDelete, "/gizclaw/v1/friend-groups/x/invite-token", ""},
	{http.MethodPost, "/gizclaw/v1/friend-groups/x/@leave", ""},
	{http.MethodGet, "/gizclaw/v1/friend-groups/x/members", ""},
	{http.MethodPost, "/gizclaw/v1/friend-groups/x/members", `{"peer_public_key":"p","member_name":"x","role":"member"}`},
	{http.MethodPut, "/gizclaw/v1/friend-groups/x/members/p", `{"role":"admin"}`},
	{http.MethodDelete, "/gizclaw/v1/friend-groups/x/members/p", ""},
}
