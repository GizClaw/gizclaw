...
const outputURL = new URL("../packages/gizclaw/generated/telemetry/peer_telemetry.ts", import.meta.url);
...
for (const expected of [
  ...
  if (!proto.includes(expected)) {
    throw new Error(`api/telemetry/peer_telemetry.proto missing ${expected}`);
  }
}

const text = `/* eslint-disable */
// This file is generated by js/scripts/generate-telemetry-protobuf.mjs.
// Do not edit by hand.
