...
export function ContactsListPage(): JSX.Element {
  ...
  const {
    ...
    prevPage,
    refresh,
  } = useCursorListPage<AdminContactObject>(async (query) => {
      ...
      <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Create an owner-scoped contact row in the peer address book.
            </DialogDescription>
          </DialogHeader>
          <form
      ...
      <Card>
        <CardHeader className="flex flex-row items-start justify-between gap-4 space-y-0">
          <div className="space-y-1">
            ...
            <CardDescription>
              Cursor-paginated social contact resources.
            </CardDescription>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          {loading ? (
            ...
            <EmptyState
              description="Contacts will appear here after they are created."
              title="No contacts"
            />
          ) : (
                  ...
                  return (
                    ...
                    >
                        ...
                        >
                          <div className="min-w-0 flex-1">
                            ...
                            <div
                              ...
                              title={contactOwnerLine(contact)}
                            >
                      ...
                      <TableCell
                        ...
                        title={contact.display_name?.trim() || "—"}
                      >
                        {contact.display_name?.trim() || "—"}
                      </TableCell>
                      <TableCell
                        className="truncate font-mono text-xs text-muted-foreground"
                        title={contact.phone_number?.trim() || "—"}
                      >
