...
void main() {
  ...
  final outDir = '$package/lib/src/generated/giznet';
  ...
  final result = Process.runSync('protoc', [
    '--proto_path=$repo/api/proto/giznet',
    '--plugin=protoc-gen-dart=${_protocGenDart(package)}',
    '--dart_out=$outDir',
    '$repo/api/proto/giznet/admission.proto',
  ]);
...
String _protocGenDart(String package) {
  ...
  if (!configFile.existsSync()) {
    throw StateError('run flutter pub get before generating admission sources');
  }
  final config =
  ...
  final wrapper = File('$package/.dart_tool/protoc-gen-dart-giznet');
