...
@$core.Deprecated('Use assetOwnerKindDescriptor instead')
const AssetOwnerKind$json = {
  '1': 'AssetOwnerKind',
  '2': [
    {'1': 'ASSET_OWNER_KIND_UNSPECIFIED', '2': 0},
    {'1': 'ASSET_OWNER_KIND_RESOURCE', '2': 1},
    {'1': 'ASSET_OWNER_KIND_FRIEND_GROUP_MESSAGE', '2': 2},
  ],
};

/// Descriptor for `AssetOwnerKind`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List assetOwnerKindDescriptor = $convert.base64Decode(
    'Cg5Bc3NldE93bmVyS2luZBIgChxBU1NFVF9PV05FUl9LSU5EX1VOU1BFQ0lGSUVEEAASHQoZQV'
    'NTRVRfT1dORVJfS0lORF9SRVNPVVJDRRABEikKJUFTU0VUX09XTkVSX0tJTkRfRlJJRU5EX0dS'
    'T1VQX01FU1NBR0UQAg==');
...
final $typed_data.Uint8List deviceInfoDescriptor = $convert.base64Decode(
    ...
    'CUgCUgJzbogBAUILCglfaGFyZHdhcmVCBwoFX25hbWVCBQoDX3Nu');
...
final $typed_data.Uint8List assetMetadataDescriptor = $convert.base64Decode(
    'Cg1Bc3NldE1ldGFkYXRhEhAKA3JlZhgBIAEoCVIDcmVmEh0KCm1lZGlhX3R5cGUYAiABKAlSCW'
    '1lZGlhVHlwZRIdCgpzaXplX2J5dGVzGAMgASgDUglzaXplQnl0ZXMSFgoGc2hhMjU2GAQgASgJ'
    'UgZzaGEyNTYSHQoKY3JlYXRlZF9hdBgFIAEoCVIJY3JlYXRlZEF0EiIKCmV4cGlyZXNfYXQYBi'
    'ABKAlIAFIJZXhwaXJlc0F0iAEBQg0KC19leHBpcmVzX2F0');

@$core.Deprecated('Use assetDownloadRequestDescriptor instead')
const AssetDownloadRequest$json = {
  '1': 'AssetDownloadRequest',
  '2': [
    {'1': 'ref', '3': 1, '4': 1, '5': 9, '10': 'ref'},
  ],
};

/// Descriptor for `AssetDownloadRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List assetDownloadRequestDescriptor = $convert
    .base64Decode('ChRBc3NldERvd25sb2FkUmVxdWVzdBIQCgNyZWYYASABKAlSA3JlZg==');

@$core.Deprecated('Use assetDownloadResponseDescriptor instead')
const AssetDownloadResponse$json = {
  '1': 'AssetDownloadResponse',
  '2': [
    {
      '1': 'metadata',
      '3': 1,
      '4': 1,
      '5': 11,
      '6': '.gizclaw.rpc.v1.AssetMetadata',
      '10': 'metadata'
    },
  ],
};

/// Descriptor for `AssetDownloadResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List assetDownloadResponseDescriptor = $convert.base64Decode(
    'ChVBc3NldERvd25sb2FkUmVzcG9uc2USOQoIbWV0YWRhdGEYASABKAsyHS5naXpjbGF3LnJwYy'
    '52MS5Bc3NldE1ldGFkYXRhUghtZXRhZGF0YQ==');

@$core.Deprecated('Use assetBindingDescriptor instead')
const AssetBinding$json = {
  '1': 'AssetBinding',
  '2': [
    {
      '1': 'owner_kind',
      ...
      '4': 1,
      '5': 14,
      '6': '.gizclaw.rpc.v1.AssetOwnerKind',
      '10': 'ownerKind'
    },
...
/// Descriptor for `AssetBinding`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List assetBindingDescriptor = $convert.base64Decode(
    'CgxBc3NldEJpbmRpbmcSPQoKb3duZXJfa2luZBgBIAEoDjIeLmdpemNsYXcucnBjLnYxLkFzc2'
    'V0T3duZXJLaW5kUglvd25lcktpbmQSGQoIb3duZXJfaWQYAiABKAlSB293bmVySWQ=');
