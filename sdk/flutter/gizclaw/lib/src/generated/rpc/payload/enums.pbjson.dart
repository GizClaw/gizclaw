...
const WorkflowDriver$json = {
  ...
  '2': [
    ...
    {'1': 'WORKFLOW_DRIVER_DASHSCOPE_REALTIME', '2': 6},
    {'1': 'WORKFLOW_DRIVER_EINO', '2': 7},
  ],
};
...
final $typed_data.Uint8List workflowDriverDescriptor = $convert.base64Decode(
    ...
    'JJVkVSX0NIQVRST09NEAQSFwoTV09SS0ZMT1dfRFJJVkVSX1BFVBAFEiYKIldPUktGTE9XX0RS'
    'SVZFUl9EQVNIU0NPUEVfUkVBTFRJTUUQBhIYChRXT1JLRkxPV19EUklWRVJfRUlOTxAH');
