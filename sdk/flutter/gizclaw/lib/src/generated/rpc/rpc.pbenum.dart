...
class RpcMethod extends $pb.ProtobufEnum {
  ...
  static const RpcMethod RPC_METHOD_SERVER_WORKSPACE_HISTORY_AUDIO_DOWNLOAD =
      RpcMethod._(
          31,
          _omitEnumNames
              ? ''
              : 'RPC_METHOD_SERVER_WORKSPACE_HISTORY_AUDIO_DOWNLOAD');
  ...
  static final $core.List<RpcMethod?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 127);
