...
func (r *ClientWebRTCRegistration) handleRPCDataChannelMessage(dc *webrtc.DataChannel, msg webrtc.DataChannelMessage) {
	...
	if err != nil {
		r.sendRPCDataChannelResponse(dc, "", rpcapi.Error{Code: rpcapi.StatusCode(-32700), Message: fmt.Sprintf("invalid rpc protobuf: %v", err)}.RPCResponse())
		return
	}
	...
	if err != nil {
		resp = rpcapi.Error{RequestID: req.Id, Code: rpcapi.StatusCode(-32000), Message: err.Error()}.RPCResponse()
	}
