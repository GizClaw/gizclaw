 ...
 */
export type ConcreteResourceWritable = CredentialResource | FirmwareResource | ContactResource | FriendResource | FriendGroupResource | FriendGroupInviteTokenResource | FriendGroupMemberResource | ModelResource | DashScopeTenantResource | DeepSeekTenantResource | GeminiTenantResource | MiniMaxTenantResource | OpenAiTenantResource | VolcTenantResource | VoiceResource | ToolResource | WorkflowResource | MemoryLayoutResource | RuntimeProfileResource | RegistrationTokenResource;
 ...
 */
export type ResourceKind = 'Credential' | 'Firmware' | 'Contact' | 'Friend' | 'FriendGroup' | 'FriendGroupInviteToken' | 'FriendGroupMember' | 'Model' | 'DashScopeTenant' | 'DeepSeekTenant' | 'GeminiTenant' | 'MiniMaxTenant' | 'OpenAITenant' | 'VolcTenant' | 'Voice' | 'Tool' | 'Workflow' | 'Workspace' | 'MemoryLayout' | 'RuntimeProfile' | 'RegistrationToken' | 'ResourceList';
...
export type PendingDeletionKind = 'peer' | 'workspace' | 'friend_group';
