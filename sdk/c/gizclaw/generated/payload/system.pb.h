...
typedef struct _gizclaw_rpc_v1_ClientRpcMethodsListRequest {
    char dummy_field;
} gizclaw_rpc_v1_ClientRpcMethodsListRequest;
...
#define gizclaw_rpc_v1_ClientRpcMethodsListRequest_FIELDLIST(X, a) \
