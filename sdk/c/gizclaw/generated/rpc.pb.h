...
typedef enum _gizclaw_rpc_v1_RpcMethod {
    ...
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_MODEL_LIST = 35,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_MODEL_GET = 36,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_VOICE_LIST = 37,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_VOICE_GET = 38,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_CONTACT_LIST = 39,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_CONTACT_GET = 40,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_CONTACT_CREATE = 41,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_CONTACT_PUT = 42,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_CONTACT_DELETE = 43,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_INVITE_TOKEN_GET = 44,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_INVITE_TOKEN_CREATE = 45,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_INVITE_TOKEN_CLEAR = 46,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_ADD = 47,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_LIST = 48,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_DELETE = 49,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_LIST = 50,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_GET = 51,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_CREATE = 52,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_PUT = 53,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_DELETE = 54,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_INVITE_TOKEN_GET = 55,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_INVITE_TOKEN_CREATE = 56,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_INVITE_TOKEN_CLEAR = 57,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_JOIN = 58,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_MEMBERS_LIST = 59,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_MEMBERS_ADD = 60,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_MEMBERS_PUT = 61,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_MEMBERS_DELETE = 62,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_MESSAGES_LIST = 63,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_MESSAGES_GET = 64,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_GROUP_MESSAGES_SEND = 65,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_BADGE_DEF_PIXA_DOWNLOAD = 66,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_PET_LIST = 67,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_PET_GET = 68,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_RUNTIME_ADOPT = 69,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_PET_PUT = 70,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_PET_DELETE = 71,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_PET_DRIVE = 72,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_POINTS_GET = 73,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_POINTS_TRANSACTIONS_LIST = 74,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_POINTS_TRANSACTIONS_GET = 75,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_BADGE_LIST = 76,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_BADGE_GET = 77,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_GAME_RESULT_LIST = 78,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_GAME_RESULT_GET = 79,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_REWARD_GRANT_LIST = 80,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_REWARD_GRANT_GET = 81,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_TOOL_LIST = 82,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_TOOL_GET = 83,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_CLIENT_TOOL_INVOKE = 84,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_PEER_LOOKUP = 85,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_PEER_ASSIGN = 86,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_ROUTE_RESOLVE = 87,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_PET_ACTIONS_GET = 88,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_PET_PIXA_DOWNLOAD = 89,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_WORKSPACE_ICON_DOWNLOAD = 90,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_FRIEND_INFO_GET = 91,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_REGISTER = 92,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_SPEECH_TRANSCRIBE = 93,
    gizclaw_rpc_v1_RpcMethod_RPC_METHOD_SERVER_SPEECH_SYNTHESIZE = 94
