...
/*
 * Acquires the sole caller-owned handle for the connection-owned, reliable
 * Peer Event Stream. connect creates the physical channel. A simultaneous
 * second handle returns GZC_ERR_INVALID_ARGUMENT.
 */
...
/* Releases only the access handle. The physical channel remains connection-owned. */
