...
envsubst_variables='${GIZCLAW_E2E_SERVER_ENDPOINT} ${GIZCLAW_E2E_EDGE_ENDPOINT} ${GIZCLAW_E2E_EDGE_PRIVATE_KEY} ${GIZCLAW_E2E_EDGE_UPSTREAM_ENDPOINT} ${GIZCLAW_E2E_EDGE_UPSTREAM_PUBLIC_KEY}'
...
if [[ "${GIZCLAW_E2E_GATEWAY_RELAY:-}" == "1" ]]; then
  ...
  : "${GIZCLAW_E2E_GATEWAY_CHANNELS_PER_SESSION:?missing GIZCLAW_E2E_GATEWAY_CHANNELS_PER_SESSION}"
  : "${GIZCLAW_E2E_GATEWAY_CHANNELS_PER_UPSTREAM:?missing GIZCLAW_E2E_GATEWAY_CHANNELS_PER_UPSTREAM}"
