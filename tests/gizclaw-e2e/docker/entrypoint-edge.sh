...
: "${GIZCLAW_E2E_TURN_RELAY_ADDRESS:?missing GIZCLAW_E2E_TURN_RELAY_ADDRESS}"
: "${GIZCLAW_E2E_TURN_REALM:?missing GIZCLAW_E2E_TURN_REALM}"
...
: "${GIZCLAW_E2E_TURN_RELAY_MIN_PORT:?missing GIZCLAW_E2E_TURN_RELAY_MIN_PORT}"
: "${GIZCLAW_E2E_TURN_RELAY_MAX_PORT:?missing GIZCLAW_E2E_TURN_RELAY_MAX_PORT}"
...
envsubst '${GIZCLAW_E2E_SERVER_ENDPOINT} ${GIZCLAW_E2E_EDGE_UPSTREAM_ENDPOINT} ${GIZCLAW_E2E_EDGE_UPSTREAM_PUBLIC_KEY} ${GIZCLAW_E2E_TURN_ENDPOINT} ${GIZCLAW_E2E_TURN_RELAY_ADDRESS} ${GIZCLAW_E2E_TURN_REALM} ${GIZCLAW_E2E_TURN_USERNAME} ${GIZCLAW_E2E_TURN_CREDENTIAL} ${GIZCLAW_E2E_TURN_RELAY_MIN_PORT} ${GIZCLAW_E2E_TURN_RELAY_MAX_PORT}' \
