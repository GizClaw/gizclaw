...
: "${GIZCLAW_E2E_EDGE_UPSTREAM_ICE_ENDPOINT:?missing GIZCLAW_E2E_EDGE_UPSTREAM_ICE_ENDPOINT}"
...
envsubst '${GIZCLAW_E2E_SERVER_ENDPOINT} ${GIZCLAW_E2E_EDGE_UPSTREAM_ENDPOINT} ${GIZCLAW_E2E_EDGE_UPSTREAM_ICE_ENDPOINT} ${GIZCLAW_E2E_EDGE_UPSTREAM_PUBLIC_KEY}' \
