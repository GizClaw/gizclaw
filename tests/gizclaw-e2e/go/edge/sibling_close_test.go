...
func aliasSetupAdminContext(t *testing.T, h *clitest.Harness) {
	...
	h.SetContextDirAlias("admin-a", filepath.Join(identitiesHome, getenvDefault("GIZCLAW_E2E_ADMIN_IDENTITY", "admin")))
}

func registerSetupPeer(t *testing.T, h *clitest.Harness, contextName, serial string, _ bool) {
	t.Helper()
