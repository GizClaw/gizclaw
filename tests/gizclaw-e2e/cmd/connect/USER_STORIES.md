...
- `say` owns process-level argument validation; provider audio behavior is exercised by the Go chat live suites.
...
- The firmware command tree has real CLI round-trip stories for its maintained state-changing paths.
