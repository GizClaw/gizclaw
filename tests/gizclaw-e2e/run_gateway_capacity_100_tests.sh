...
export GIZCLAW_E2E_GATEWAY_EXTENDED_ARTIFACT_DIR="${GIZCLAW_E2E_GATEWAY_100_ARTIFACT_DIR:-$script_dir/testdata/gateway-capacity-extended/sessions-100-burst}"
